...
function TableOrders() {
    ...
    async function captureFunds() {
        ...
        switch (paymentMethod) {
            ...
            case "stripe": {
                setLoading(true);
                response = await captureFundsRequest(
        ...
        >
                        ...
                        {orders.map((order, index) => (
                            ...
                            >
                                ...
                                <TableCell align="center">
                                    {paymentMethodIndex[order.paymentMethod]}
                                </TableCell>
                                <TableCell align="center">
                                    <Typography
                                        sx={{
            ...
            <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                ...
                {currentOrder && !currentOrder.url ? (
                    <MenuItem onClick={addUrl} disabled={loading}>
                        <>
                            subir imagen
                            <input
                                type="file"
                ...
                {currentOrder?.paid === false ? (
                    <MenuItem onClick={captureFunds} disabled={loading}>
                        Validar pago
                    </MenuItem>
                ) : null}
                <MenuItem
