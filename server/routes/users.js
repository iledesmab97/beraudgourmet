...
const {getAllUsers, getUser, isEmailRegistered, signUp, signUpAdmin, logIn, logOut, updateMyAccount, updateUser, removeMyAccount, removeUser, verifyUser } = require('../controllers/users.controller')
